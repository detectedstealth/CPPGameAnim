...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int iCmdShow) {
	...
	wndclass.lpszClassName = reinterpret_cast<LPCWSTR>(L"Win32 Game Window");
	...
	HWND hwnd = CreateWindowEx(0, wndclass.lpszClassName, reinterpret_cast<LPCWSTR>(L"Game Window"), style, windowRect.left, windowRect.top, windowRect.right - windowRect.left, windowRect.bottom - windowRect.top, NULL, NULL, hInstance, szCmdLine);
	HDC hdc = GetDC(hwnd);
